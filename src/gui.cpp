...
// We Are Going to use our custom implementation for rendering ImGui's Draw Data
...
void gui_open_popup(const char *title, int flags, void *data, int (*func)(void *data))
{
	typeof(gui->popup[0]) *popup;
